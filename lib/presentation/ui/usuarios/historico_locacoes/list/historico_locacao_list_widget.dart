...
class HistoricoLocacaoListWidget extends StatefulWidget {
  final AtivoUsuariosLocacao ativoUsuarioLocacao;

  const HistoricoLocacaoListWidget(
    this.ativoUsuarioLocacao, {
    Key? key,
  }) : super(key: key);

  @override
  State<HistoricoLocacaoListWidget> createState() => _HistoricoLocacaoListWidgetState();
}

class _HistoricoLocacaoListWidgetState extends State<HistoricoLocacaoListWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return AppDismissible(
      ...
      startToEnd: () {},
      onDoubleTap: () {
        Map data = {'id': widget.ativoUsuarioLocacao.id, 'view': true, 'isClienteView': false};
            ...
            child: Padding(
              ...
              child: Card(
                ...
                child: ExpansionTile(
                  ...
                  subtitle: Text(
                    (widget.ativoUsuarioLocacao.clienteNome).toString(),
                    style: TextStyle(
                      color: AppColors.black,
                    ),
                  ),
