...
Future<void> populateControllerAtivoLocar(Ativo ativo, AtivoController controllers) async {
  ...
  controllers.pagamentoDiaHoraNome!.text = ativo.pagamentoDiaHoraNome ?? '';
}
